...
<body>
	...
	<br>
			...
			<br><br><br>
	<input style="width: 192px; margin-bottom: 5px;" class="btn btn-danger btn-lg" type="button" value="아이디 찾기" id="forgotId"><p style="margin: 5px; display: inline;"></p>
	<input style="width: 192px; margin-bottom: 5px;" class="btn btn-danger btn-lg" type="button" value="비밀번호 찾기" id="forgotPassword"><br>
